...
Note: RStudio could not access files in the 'data' folder simply by writing 'data/', because the 'data' folder was located on a different level. To access files in the 'data' folder, we therefore had to write '../data' in order to locate it correctly. 
