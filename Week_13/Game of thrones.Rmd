...
Let's do sentiment analysis on the Game of Thrones text data using afinn, and nrc. 
...
ggplot(data = got_afinn2_n, aes(x = word, y = n)) +
  ...
  coord_flip() +
  theme_bw()
ggsave("sentiment_plot.png", width= 10,height = 20,limitsize = FALSE)
...
Or we can summarize sentiment for the text: 
```{r summarize-afinn}
...
got_nrc_gg <- ggplot(data = got_n5, aes(x = reorder(word,n), y = n, fill = sentiment)) +
